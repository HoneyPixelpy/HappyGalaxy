...
class BonusesMethods:
    ...
    def create_add_starcoins(
        ...
        return AddStarcoinsBonus.objects.create(
            _value=value,
            max_quantity=max_quantity
        )
    @classmethod
    def create_click_scale(
        cls,
        value: int,
        duration_hours: int
        ) -> Bonuses:
    ...
    def create_energy_renewal(
        ...
        return EnergyRenewalBonus.objects.create(
            _duration_hours=duration_hours
        )
    @classmethod
    def create(
        ...
        raise RaisesResponse(
            data=BonusesSerializer(bonus).data, 
...
class UseBonusesMethods(UserGameMethods):
    ...
    def create_add_starcoins(
        ...
        if (bonus_data.use_quantity >= bonus_data.max_quantity or 
