...
router.register(r'boosts_data', BoostsViewSet, basename='boosts_data')
router.register(r'copy-base', CopyBaseViewSet, basename='copy-base')
router.register(r'rangs', RangsViewSet, basename='rangs')
router.register(r'quest-moderation-attempt', QuestModerationAttemptViewSet, basename='quest-moderation-attempt')
