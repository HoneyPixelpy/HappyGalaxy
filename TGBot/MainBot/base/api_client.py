...
class DjangoAPI:
    ...
    def __init__(self):
        self.base_url = "http://{}/api/v1".format(os.getenv("DJANGO_API_LINK"))
                ...
                async with session.request(
                    ...
                    if response.status == 200 or response.status == 201:
                        ...
                        try:
                            ...
                            logger.error(
                                f"Failed to process response: {e.__class__.__name__}"
                            )
...
class UsersRequests(DjangoAPI):
    ...
    async def check_nickname(self, nickname: str) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/users/check_nickname/", params={"nickname": nickname}
        )

    async def complete_registration(self, user_id, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PUT", f"/users/{user_id}/complete_registration/", user_data
        )

    async def update_username(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/users/update_telegram_username/", user_data
        )

    async def update_balance(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request("PATCH", "/users/update_balance/", user_data)

    async def update_ban(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request("PATCH", "/users/update_ban/", user_data)
    ...
    async def update_vk_id(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request("PATCH", "/users/update_vk_id/", user_data)
    ...
    async def back_vk_id(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request("DELETE", "/users/back_vk_id/", user_data)

    async def active_users(self, data: Dict) -> Optional[Dict]:
        return await self._make_request("GET", "/users/active_users/", data)
...
class PurchasesRequests(DjangoAPI):
    ...
    async def get_user_purchases(self, user_id: int, completed: bool) -> Optional[Dict]:
        return await self._make_request(
            ...
            params={"completed": str(completed), "user_id": user_id},
        )
    ...
    async def confirm_purchase(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/purchases/confirm_purchase/", user_data
        )

    async def add_message_id(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/purchases/add_message_id/", user_data
        )

    async def cancel_buy(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/purchases/cancel_buy/", user_data
        )

    async def success_buy(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/purchases/success_buy/", user_data
        )
...
class Sigma_BoostsRequests(DjangoAPI):
    ...
    async def get_catalog_boosts(self, user_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/sigma-boosts/catalog", params={"user_id": user_id}
        )

    async def get_info_boost(self, user_id: int, name: str) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/sigma-boosts/info", params={"user_id": user_id, "name": name}
        )

    async def get_by_user(self, user_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/sigma-boosts/get_by_user/", params={"user_id": user_id}
        )

    async def add_passive_income(self, user_id) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", f"/sigma-boosts/{user_id}/add_passive_income/"
        )

    async def upgrade_boost(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/sigma-boosts/upgrade_boost/", user_data
        )

    async def calculate_recovery_time(self, user_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/sigma-boosts/calculate_recovery_time/", params={"user_id": user_id}
        )
...
class Lumberjack_GameRequests(DjangoAPI):
    ...
    async def update_grid(self, game_user_id, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", f"/lumberjack-games/{game_user_id}/update_grid/", user_data
        )

    async def process_click(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/lumberjack-games/process_click/", user_data
        )

    async def restore_energy(self, game_user_id) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", f"/lumberjack-games/{game_user_id}/restore_energy/"
        )

    async def game_state(self, user_id: int) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", f"/lumberjack-games/{user_id}/game_state/"
        )
...
class GeoHunter_GameRequests(DjangoAPI):
    ...
    async def process_click(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/geo-hunter/process_click/", user_data
        )

    async def restore_energy(self, game_user_id) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", f"/geo-hunter/{game_user_id}/restore_energy/"
        )

    async def game_state(self, user_id: int) -> Optional[Dict]:
        return await self._make_request("PATCH", f"/geo-hunter/{user_id}/game_state/")
...
class Work_KeysRequests(DjangoAPI):
    ...
    async def check_by_key(self, key: str) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/work-keys/check_by_key/", params={"key": key}
        )

    async def register_with_key(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/work-keys/register_with_key/", user_data
        )
...
class QuestsRequests(DjangoAPI):
    ...
    async def get_info(self, user_id: int, quest_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET",
            "/quests/get_info/",
            params={"user_id": user_id, "quest_id": quest_id},
        )
    ...
    async def get_active_quests(self, user_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/quests/active/", params={"user_id": user_id}
        )
...
class UseQuestsRequests(DjangoAPI):
    ...
    async def get_all_sub_tg_chat(self, quest_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/use-quests/sub_tg_chat/", params={"quest_id": quest_id}
        )

    async def get_all_sub_vk_chat(self, quest_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/use-quests/sub_vk_chat/", params={"quest_id": quest_id}
        )
    ...
    async def success_idea_daily(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", "/use-quests/success_idea_daily/", user_data
        )

    async def delete_quest(self, user_data: Dict) -> Optional[Dict]:
        return await self._make_request("DELETE", "/use-quests/delete_idea/", user_data)
...
class RangsRequests(DjangoAPI):
    ...
    async def get_by_role(self, role: str) -> Optional[Dict]:
        return await self._make_request("GET", "/rangs/role/", params={"role": role})
...
class InteractiveGameRequests(DjangoAPI):
    ...
    async def success_game(self, game_id: int) -> Optional[Dict]:
        return await self._make_request(
            "POST", "/interactive-game/success_game/", data={"game_id": game_id}
        )
    ...
    async def delete_pending(self, game_id: int) -> Optional[Dict]:
        return await self._make_request(
            "DELETE", f"/interactive-game/{game_id}/delete_pending/"
        )

    async def start_game(self, game_id: int) -> Optional[Dict]:
        return await self._make_request(
            "PATCH", f"/interactive-game/{game_id}/start_game/"
        )

    async def get_info(self, game_id: int) -> Optional[Dict]:
        return await self._make_request(
            "GET", "/interactive-game/get_info/", params={"game_id": game_id}
        )
