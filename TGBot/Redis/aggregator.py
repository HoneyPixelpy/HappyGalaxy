...
class RedisAggregator:
    ...
    async def add_message(
        ...
        """
        if not self.redis: self.redis = await RedisManager().get_redis()
...
class MessageAggregator(RedisAggregator):
    ...
    async def add_message(
        ...
        """
        text, content_type, media_content, media_group_id = await Func.parsing_message(message)
